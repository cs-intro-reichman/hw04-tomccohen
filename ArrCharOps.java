...
public class ArrCharOps {
    ...
    public static int indexOf(char[] arr, char ch, int fromIndex) {
        if (fromIndex - 1 >= arr.length || fromIndex < 0) { return -1; }
    ...
    */
        ...
        // int[] new_arr = new int[lenght1 + lenght2]
        // for // insert arr1 elements
        // for 2 // insert arr2 elemnts from index=arr1.length
        // return null;
